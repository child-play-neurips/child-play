...
def main():
    parser = argparse.ArgumentParser(description='Process Connect Four game logs and generate plots.')
    parser.add_argument('--scatter', action='store_true', help='Generate scatter plots instead of bar plots.')
